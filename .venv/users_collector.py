...
class QuestionnaireBuilder:
    ...
    STUDIO_QUESTIONNAIRES = {
        1: {
            ...
            'questions': [
                ...
                'email',  # 4. Email
                'project_ideas',  # 5. Идеи для проектов
                'experience',  # 6. Опыт
                'motivation',
        ...
        6: {
            ...
            'questions': [
                ...
                'email',  # 4. Email
                'experience',  # 5. Опыт
                'quote',  # 6. Цитата (ИСПРАВЛЕНО: было 'quot')
                'public_speaking',  # 7. Публичные выступления (ИСПРАВЛЕНО: было 'public_speakin')
            ]
        },
        2: {
            ...
            'questions': [
                ...
                'improvisation',  # 7. Импровизация
                'feedback_source',  # 8. Источник информации
            ]
        },
        4: {
            'name': 'МУЗГУАП',
            'questions': [
                ...
                'public_speaking',  # 7. Публичные выступления (ИСПРАВЛЕНО)
                'activeness',  # 8. Участие в мероприятиях
            ]
        },
        5: {
        ...
        3: {
            ...
            'questions': [
                ...
                'leadership',  # 7. Лидерские качества
                'feedback_source',  # 8. Источник информации
            ]
        },
        7: {
        ...
        8: {
            ...
            'questions': [
                ...
                'email',  # 4. Email
                'experience',  # 5. Опыт
                'public_speaking',  # 6. Публичные выступления (ИСПРАВЛЕНО)
                'quote',  # 7. Цитата (ИСПРАВЛЕНО: было 'quot')
                'improvisation',  # 8. Импровизация
            ]
        },
    }
    ...
    def generate_summary(cls, studio_id: int, answers: Dict[str, str]) -> str:
        ...
        summary = f"Заявка в студию: {studio_name}\n\n"
